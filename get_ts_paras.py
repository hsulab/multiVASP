...
def get_ts_paras(abc, l1, l2, CH4, cif_name):
    ...
    ##
    ts_paras = [name, dH1_O2, dH1_C, dO2_M4, dC_M4, dM4_l2O2, \
            aO8_O2_H1, aC_M4_l2O2, aH1_C_H2]
    return ts_paras
...
def get_ts_cifs():
    ...
    ###
    ts_csv = os.path.join(os.path.expanduser('~'), 'Desktop/ts_data.csv')
    ### pd.DataFrame
    ts_df = pd.DataFrame(columns=('name', 'dH1_O2', 'dH1_C', \
            'dO2_M4', 'dC_M4', 'dM4_l2O2', 'aO8_O2_H1', \
            'aC_M4_l2O2', 'aH1_C_H2'))
    row_index = 1
    ###
