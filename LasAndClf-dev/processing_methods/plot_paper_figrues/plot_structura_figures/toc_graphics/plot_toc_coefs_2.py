...
def plot_main():
    ...
    # ax2
    ax[1].text(0.2, 0.9, 'Geometrical\nDescriptors', fontsize=24, fontweight='bold')
    ax[1].text(-0.1, 0.9, r'$\bf{\stackrel{ss}{\longleftarrow}}$', fontsize=36)
    ax[1].text(0.9, 0.9, r'$\bf{\stackrel{ra}{\longrightarrow}}$', fontsize=36)
    ax[1].set_axis_off()
    ...
    plot_selected_features(ax[2], features, feanames)
