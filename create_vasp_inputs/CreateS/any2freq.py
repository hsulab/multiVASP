...
'''
*Usage*
any2freq.py [Dir] [Reaction] [metal]

*Example*
[in] any2freq.py . ts Ir
[out] 
...
def prepare_freq(finished_dirs, reaction):
    'rtype' 
    rtype={}
    rtype['Hab_sp2'], rtype['Hab_sp3'] = 1, 1
    rtype['CH3ab'] = 4
    rtype['ts'], rtype['ts_ra'] = 5, 5
    rtype['fs'] = 5
...
def main():
    if len(sys.argv) == 1:
        ...
        'Get argvs'
        work_dir, reaction, element = sys.argv[1], sys.argv[2], sys.argv[3]

        ''
        finished_dirs = []
        converged_dirs = CheckOut.check_printout(work_dir, reaction)
        ...
        print('Finished Dirs: ', end='')
        for i in finished_dirs:
            print(i, end=', ')
        print('Preparing Frequency Files ...')
