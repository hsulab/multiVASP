...
def norm_data(geo_file, rE_file):
    ...
    if 'suf' in geo_file_name:
        ...
        if 'Hab2' in geo_file_name:
            reaction = 'E_Hab2'
        elif 'Hab3' in geo_file_name:
            reaction = 'E_Hab3'
        elif 'CH3ab' in geo_file_name:
            reaction = 'E_CH3ab'
        elif 'ts' in geo_file_name:
            reaction = 'E_ts'
        elif 'fs' in geo_file_name:
            reaction = 'E_fs'
        elif 'tsra' in geo_file_name:
            reaction = 'E_tsra'
        elif 'fsra' in geo_file_name:
            reaction = 'E_fs'
        ### get E
        E_dict = {}
...
###
def main():
    rE_file = os.path.join(os.path.expanduser('~'), 'Desktop/rE_data_20180910.csv')
    ###
    #ts_file = os.path.join(os.path.expanduser('~'), 'Desktop/ts_data_20180910.csv')
    hab2_file = os.path.join(os.path.expanduser('~'), 'Desktop/Hab2_data_20180910.csv')
    hab3_file = os.path.join(os.path.expanduser('~'), 'Desktop/Hab3_data_20180510.csv')
    ch3ab_file = os.path.join(os.path.expanduser('~'), 'Desktop/CH3ab_data_20180910.csv')
    ###
    tsE_file = os.path.join(os.path.expanduser('~'), 'Desktop/ts_data_20180910_E.csv')
    hab2E_file = os.path.join(os.path.expanduser('~'), 'Desktop/Hab2_data_20180910_E.csv')
    hab3E_file = os.path.join(os.path.expanduser('~'), 'Desktop/Hab3_data_20180910_E.csv')
    ch3abE_file = os.path.join(os.path.expanduser('~'), 'Desktop/CH3ab_data_20180910_E.csv')
    ###
    '''
